This is a simple Python-based Virtual Assistant that can perform tasks such as playing songs on YouTube, telling the current time, retrieving information from Wikipedia, and telling jokes. 
